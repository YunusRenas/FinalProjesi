...
class Hasta:
    ...
    def tedavi_suresi_hesapla(self, tedavi_baslangic, tedavi_bitis):
        tedavi_baslangic = datetime.strptime(tedavi_baslangic, "%Y-%m-%d")
        tedavi_bitis = datetime.strptime(tedavi_bitis, "%Y-%m-%d")
        tedavi_suresi = (tedavi_bitis - tedavi_baslangic).days
